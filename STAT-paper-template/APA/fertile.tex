...
\end{alltt}
\begin{verbatim}
## /tmp/RtmpqsLI66/project_miceps
\end{verbatim}
\begin{alltt}
\hlstd{fs}\hlopt{::}\hlkwd{dir_ls}\hlstd{(temp_dir)} \hlopt{%>%} \hlkwd{head}\hlstd{(}\hlnum{3}\hlstd{)}
\end{alltt}
\begin{verbatim}
## /tmp/RtmpqsLI66/project_miceps/Blot_data_updated.csv
## /tmp/RtmpqsLI66/project_miceps/CS_data_redone.csv
## /tmp/RtmpqsLI66/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
\end{kframe}
\end{knitrout}
