...
##   <chr>        <chr>                                <chr>    <dttm>             
## 1 package:pur~ <NA>                                 base::l~ 2020-10-11 15:10:40
## 2 package:for~ <NA>                                 base::l~ 2020-10-11 15:10:40
## 3 Seed Before  <NA>                                 14       2020-10-11 15:10:40
## 4 project_mic~ /Users/audreybertin/Documents/ferti~ readr::~ 2020-10-11 15:10:40
## 5 Seed After   <NA>                                 28       2020-10-11 15:10:40
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmpz372mQ/project_miceps
\end{verbatim}
\begin{alltt}
\hlstd{fs}\hlopt{::}\hlkwd{dir_ls}\hlstd{(temp_dir)} \hlopt{%>%} \hlkwd{head}\hlstd{(}\hlnum{3}\hlstd{)}
\end{alltt}
\begin{verbatim}
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmpz372mQ/project_miceps/Blot_data_updated.csv
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmpz372mQ/project_miceps/CS_data_redone.csv
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/Rtmpz372mQ/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
\end{kframe}
\end{knitrout}
