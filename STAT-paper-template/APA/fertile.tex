...
##   <chr>        <chr>                                <chr>    <dttm>             
## 1 package:pur~ <NA>                                 base::l~ 2020-08-09 15:41:03
## 2 package:for~ <NA>                                 base::l~ 2020-08-09 15:41:03
## 3 project_mic~ /Users/audreybertin/Documents/ferti~ readr::~ 2020-08-09 15:41:03
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{verbatim}
\begin{alltt}
\hlstd{fs}\hlopt{::}\hlkwd{dir_ls}\hlstd{(proj_dir)} \hlopt{%>%} \hlkwd{head}\hlstd{(}\hlnum{1}\hlstd{)}
\end{alltt}
\begin{verbatim}
...
\end{alltt}
\begin{verbatim}
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpJ7VyPP/project_miceps
\end{verbatim}
\begin{alltt}
\hlstd{fs}\hlopt{::}\hlkwd{dir_ls}\hlstd{(temp_dir)} \hlopt{%>%} \hlkwd{head}\hlstd{(}\hlnum{1}\hlstd{)}
\end{alltt}
\begin{verbatim}
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpJ7VyPP/project_miceps/Blot_data_updated.csv
\end{verbatim}
\end{kframe}
\end{knitrout}
