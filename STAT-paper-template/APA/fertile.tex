...
{\ttfamily\noindent\itshape\color{messagecolor}{\#\# Error in eval\_tidy(xs[[j]], mask): object '.Random.seed' not found}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# -- Running reproducibility checks -------- fertile 0.0.0.9028 --}}

{\ttfamily\noindent\itshape\color{messagecolor}{\#\# -- Rendering R scripts... ---------------- fertile 0.0.0.9028 --}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in eval\_tidy(xs[[j]], mask): object '.Random.seed' not found}}\end{kframe}
\end{knitrout}
...
##   <chr>        <chr>                                <chr>    <dttm>             
## 1 package:pur~ <NA>                                 base::l~ 2020-10-10 00:39:23
## 2 package:for~ <NA>                                 base::l~ 2020-10-10 00:39:23
## 3 project_mic~ /Users/audreybertin/Documents/ferti~ readr::~ 2020-10-10 00:39:23
\end{verbatim}
\end{kframe}
\end{knitrout}
...
\end{alltt}
\begin{verbatim}
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpNAq0UZ/project_miceps
\end{verbatim}
\begin{alltt}
\hlstd{fs}\hlopt{::}\hlkwd{dir_ls}\hlstd{(temp_dir)} \hlopt{%>%} \hlkwd{head}\hlstd{(}\hlnum{3}\hlstd{)}
\end{alltt}
\begin{verbatim}
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpNAq0UZ/project_miceps/Blot_data_updated.csv
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpNAq0UZ/project_miceps/CS_data_redone.csv
## /var/folders/v6/f62qz88s0sd5n3yqw9d8sb300000gn/T/RtmpNAq0UZ/project_miceps/Estrogen_Receptors.docx
\end{verbatim}
\end{kframe}
\end{knitrout}
